...
import com.videoseekbar.indicator.IndicatorType
...
class Builder internal constructor(val context: Context) {
    ...
    var indicatorColor = Color.parseColor("#F32677")
    var indicatorTextColor = Color.parseColor("#000000")
    ...
    var trackBackgroundColor = Color.parseColor("#00ffffff")
    var trackProgressSize = 0
    var trackProgressColor = Color.parseColor("#00ffffff")
    var trackHighlightedColor = Color.parseColor("#00ffffff")
    var trackRoundedCorners = false

    //thumbText
    var thumbTextColor = Color.parseColor("#00ffffff")
    var showThumbText = false

    //thumb
    var thumbSize = 0
    var thumbColor = Color.parseColor("#F32677")
    var thumbColorStateList: ColorStateList? = null
    var thumbDrawable: Drawable? = null

    //thumbPin
    var thumbPinSize = 0
    var thumbPinColor = Color.parseColor("#F32677")
    var thumbPinColorStateList: ColorStateList? = null
    var thumbPinDrawable: Drawable? = null
    ...
    var tickMarksColor = Color.parseColor("#FFFFFF")
    var tickMarksSize = 0
    ...
    /**
     * call this to new an VideoSeekBar
     *
     * @return VideoSeekBar
     */
    fun build(): VideoSeekBar {
        return VideoSeekBar(this)
    }
    ...
    fun indicatorTextSize(indicatorTextSize: Int): Builder {
        this.indicatorTextSize = FormatUtils.sp2px(context, indicatorTextSize.toFloat())
        return this
    }
    ...
    fun trackBackgroundSize(trackBackgroundSize: Int): Builder {
        this.trackBackgroundSize = FormatUtils.dp2px(context, trackBackgroundSize.toFloat())
        return this
    }
    ...
    fun trackProgressSize(trackProgressSize: Int): Builder {
        this.trackProgressSize = FormatUtils.dp2px(context, trackProgressSize.toFloat())
        return this
    }
     ...
     * @return Builder
     */
    fun trackHighlightedColor(@ColorInt trackHighlightedColor: Int): Builder {
        this.trackHighlightedColor = trackHighlightedColor
        return this
    }
     ...
     * @return Builder
     */
    fun thumbPinColor(@ColorInt thumbColor: Int): Builder {
        this.thumbPinColor = thumbColor
        return this
    }
    ...
    //<item android:color="@color/color_blue" />                                <!--for thumb which is at normal status-->
    //</selector>
    fun thumbPinColorStateList(thumbColorStateList: ColorStateList): Builder {
        this.thumbPinColorStateList = thumbColorStateList
        return this
    }
    ...
    fun thumbSize(thumbSize: Int): Builder {
        this.thumbSize = FormatUtils.dp2px(context, thumbSize.toFloat())
        return this
    }
     ...
     * @return Builder
     */
    fun thumbPinSize(thumbSize: Int): Builder {
        this.thumbPinSize = FormatUtils.dp2px(context, thumbSize.toFloat())
        return this
    }
     ...
     * @return Builder
     */
    fun thumbPinDrawable(thumbDrawable: Drawable): Builder {
        this.thumbPinDrawable = thumbDrawable
        return this
    }
    ...
    //<item android:drawable="Your drawableB" />  < !--for thumb when normal-->
    //</selector>
    fun thumbPinDrawable(thumbStateListDrawable: StateListDrawable): Builder {
        thumbPinDrawable = thumbStateListDrawable
        return this
    }
    ...
    fun tickTextsSize(tickTextsSize: Int): Builder {
        this.tickTextsSize = FormatUtils.sp2px(context, tickTextsSize.toFloat())
        return this
    }
    ...
    fun tickMarksSize(tickMarksSize: Int): Builder {
        this.tickMarksSize = FormatUtils.dp2px(context, tickMarksSize.toFloat())
        return this
    }
    ...
    init {
        indicatorTextSize = FormatUtils.sp2px(context, 14f)
        trackBackgroundSize = FormatUtils.dp2px(context, 2f)
        trackProgressSize = FormatUtils.dp2px(context, 2f)
        tickMarksSize = FormatUtils.dp2px(context, 10f)
        tickTextsSize = FormatUtils.sp2px(context, 13f)
        thumbSize = FormatUtils.dp2px(context, 18f)
        thumbPinSize = FormatUtils.dp2px(context, 14f)
    }
}