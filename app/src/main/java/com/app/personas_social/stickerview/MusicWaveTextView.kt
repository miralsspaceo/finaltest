...
class MusicWaveTextView @JvmOverloads constructor(
        context: Context,
...
//        spanTextPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD);
        ...
        private fun bound(anchor: Int, gravity: Int): Rect {
            ...
            when (gravity and Gravity.HORIZONTAL_GRAVITY_MASK) {
                Gravity.CENTER_HORIZONTAL -> rect.left = anchor - 0 / 2+15
        ...
        companion object {
            private val TAG = MusicWaveTextView::class.java.simpleName
        ...
        init {
            ...
            id =
                typedArray.getResourceId(R.styleable.TextRangeView_background, R.drawable.ic_drawble)
            if (id != -1) {
