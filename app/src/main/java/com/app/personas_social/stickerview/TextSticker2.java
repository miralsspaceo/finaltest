...
public class TextSticker2 extends Sticker   {
    ...
    public TextSticker2(@NonNull Context context) {
        this(context, null);
    }

    private TextSticker2(@NonNull Context context, @Nullable Drawable drawable) {
...
//        textView.draw(canvas);
    ...
    @NonNull
    @Override
    public TextSticker2 setAlpha(@IntRange(from = 0, to = 255) int alpha) {
    ...
    @Override
    public TextSticker2 setDrawable(@NonNull Drawable drawable) {
        this.drawable = drawable;
    ...
    public TextSticker2 setGradient(int color1, int color2) {
        color = new int[]{color1, color2};
        textPaint.setShader(new LinearGradient(0f, 0f, getWidth(), height, color, null,
    ...
    public TextSticker2 setPattern(int pattern) {
    ...
    @NonNull
    public TextSticker2 setDrawable(@NonNull Drawable drawable, @Nullable Rect region) {
        this.drawable = drawable;
        realBounds.set(0, 0, getWidth(), getHeight());
        if (region == null) {
            textRect.set(0, 0, getWidth(), getHeight());
    ...
    @NonNull
    public TextSticker2 setTypeface(@Nullable Typeface typeface) {
    ...
    @NonNull
    public TextSticker2 setPaintToOutline(@ColorInt int color, String type) {
        strokeWidth = 10f;
        borderColor = color;
        mType = type;
    ...
    @NonNull
    public TextSticker2 setTextColor(@ColorInt int color) {
...
//       textPaint.setStrokeWidth(strokeWidth);
    ...
    @NonNull
    public TextSticker2 setTextAlign(@NonNull Layout.Alignment alignment) {
        this.alignment = alignment;
        return this;
    }

    @NonNull
    public TextSticker2 setMaxTextSize(@Dimension(unit = Dimension.SP) float size) {
//        textPaint.setTextSize(convertSpToPx(size));
     ...
     */
    @NonNull
    public TextSticker2 setMinTextSize(float minTextSizeScaledPixels) {
        minTextSizePixels = convertSpToPx(minTextSizeScaledPixels);
        return this;
    }

    @NonNull
    public TextSticker2 setLineSpacing(float multiplier, float add) {
    ...
    @NonNull
    public TextSticker2 setText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     */
    @NonNull
    public TextSticker2 resizeText() {
...
//        textView.setWidth(textRect.width());
//        textView.setHeight(textRect.height());
...
//        textView.setTextColor(textPaint.getColor());
    ...
    @NonNull
    public TextSticker2 setLetterSpacing(float spacing) {
