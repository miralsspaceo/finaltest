...
object PreferenceHelper {
    ...
    const val PREF_AUDIO_RECORD = "PREF_AUDIO_RECORD"
    ...
    operator fun SharedPreferences.set(key: String, value: Any?) {
        when (value) {
            ...
            is ArrayList<*> -> edit {
                it.putString(
                    key,
                    stringArrayToString(value as ArrayList<String>)
                )
            }
    ...
    private fun stringArrayToString(arr: List<String>) = TextUtils.join(",", arr)
}